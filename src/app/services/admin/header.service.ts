...
ProjectfieldCreate(_data: any) {
  ...
  ProjectfieldEdit(_data: any) {
    ...
    GetRoleCategeoryOnUserId(id: any) {
    return this._httpService._getMethod( 'api/services/app/UserZoneMapping/GetRoleCategeoryOnUserId?UserId='+id);
  }
