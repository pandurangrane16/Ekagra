...
@Component({
 ...
 imports: [
  ...
  styleUrl: './role-config-list.component.css'
})

export class RoleConfigListComponent  {
loaderService =inject(LoaderService)
router = inject(Router);
_headerName = 'Role Configuration Table';
headArr: any[] = [];
...
buildHeader() {  
          this.headArr = [
            ...
            { header: 'Source Url', fieldValue: 'sourceURL', position: 3 , cellClass: 'wrap-text' },
            { header: 'Description', fieldValue: 'description', position: 4 },
            { header: 'Min Zoom', fieldValue: 'minZoom', position: 5 },
            { header: 'Max Zoom', fieldValue: 'maxZoom', position: 6 },
            { header: 'Wms Layer', fieldValue: 'wmsLayer', position: 7 , cellClass: 'wrap-text' },
