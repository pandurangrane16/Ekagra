...
export class ApiListComponent implements OnInit {
  ...
  getFilteredList() {
    ...
    this.service.GetFilteredList(selectedProjectId, projtype, search, selectedStatus, this.MaxResultCount, this.SkipCount).
    pipe(withLoader(this.loaderService)).subscribe((response:any) => {
